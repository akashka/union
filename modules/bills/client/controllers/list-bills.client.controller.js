(function() {
  ...
  function BillsListController(
    ...
    BillsService.getPrimaryDetails().$promise.then(function(response) {
      ...
      vm.allBillTos = response.data.bill_to;
      vm.isLoading++;
    });
      ...
      self.tableParams = new NgTableParams(
        ...
        },
        {
          ...
          getData: function($defer, params) {
            ...
            return BillsService.filteredBills(param).$promise.then(
              function(response) {
        ...
        $http.delete("/api/bills/" + id).then(function(response) {
          if (response.status == 200) {
            ...
            Notification.error({
              ...
              title:
                '<i class="glyphicon glyphicon-remove"></i> Bill deletion error!'
            });
          }
        });
      } else {
    ...
    vm.download = function(billId) {
      // BillsService.downloads(billId)
      // .then(function (res) {
      // var file = new Blob([res], { type: 'application/pdf' });
      var fileurl = "/api/downloads/" + billId;
